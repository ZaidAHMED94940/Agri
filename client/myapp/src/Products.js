    ...
    return (
        <div className="Products">
            ...
            <div className="cardgrid">
                ...
                <div class="card">
                    <img id="potato" src={potato} alt="Card image cap" />
                    <div class="card-body">
                ...
                <div class="card">
                    <img id="cauliflower" src={cauliflower} alt="Card image cap" />
                    <div class="card-body">
            ...
            <div className="cardgrid">
                <div class="card">
                    <img id="potato" src={tomatoes} alt="Card image cap" />
                    <div class="card-body">
            ...
            <div className="cardgrid">
                ...
                <div class="card">
                    <img id="potato" src={chillies} alt="Card image cap" />
                    <div class="card-body">
                ...
                <div class="card">
                    <img id="potato" src={Peas} alt="Card image cap" />
                    <div class="card-body">
